 ...
 */
function GalleryCard({ item, index, isInView, onOpen }: GalleryCardProps) {
  ...
  return (
    ...
    >
      <article>
        <button
          type="button"
          className="group w-full cursor-pointer text-left outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
          onClick={() => onOpen(item)}
        ...
        >
          ...
          <div className="mt-4 lg:hidden">
            ...
            <h3 className="mt-1.5 font-display text-xl text-primary">
              {item.caption}
            </h3>
          </div>
        </button>
 ...
 * and a lightbox for full, uncropped viewing.
 */
